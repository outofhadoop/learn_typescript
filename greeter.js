...
function add(num1, num2) {
    ...
    for (var _i = 2; _i < arguments.length; _i++) {
        resetOfNum[_i - 2] = arguments[_i];
    }
    return num1 + num2 + resetOfNum.reduce(function (accumulator, currentValue, currentIndex) { return accumulator + currentValue; });
}
...
var Add = /** @class */ (function () {
    ...
    Add.prototype.innerAdd = function () {
        console.log(this.num);
    };
    return Add;
}());
var instanceAdd = new Add();
